    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('admin.dashboard') }}">Baroli Police</a>
                <a class="navbar-brand hidden" href="{{ route('admin.dashboard') }}">BP</a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href=""><i class="menu-icon fa fa-newspaper-o"></i>News</a>
                    </li>
                    <li>
                        <a href=""><i class="menu-icon fa fa-user-times"></i>Missing Person</a>
                    </li>
                    <li>
                        <a href=""><i class="menu-icon fa fa-bed"></i>Dead Bodies</a>
                    </li>
                    <li>
                        <a href=""><i class="menu-icon fa fa-car"></i>Stolen Vehicle</a>
                    </li>
                    <li>
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media bg-flat-color-1" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="{{ url('backend/images/avatar/1.jpg') }}"></span>
                                ...
                                <a class="dropdown-item media bg-flat-color-4" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="{{ url('backend/images/avatar/2.jpg') }}"></span>
                                    <span class="message media-body">
                                ...
                                <a class="dropdown-item media bg-flat-color-5" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="{{ url('backend/images/avatar/3.jpg') }}"></span>
                                    <span class="message media-body">
                                ...
                                <a class="dropdown-item media bg-flat-color-3" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="{{ url('backend/images/avatar/4.jpg') }}"></span>
                                    <span class="message media-body">
